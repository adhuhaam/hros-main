...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('employees.show', $employee) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg">
                <i class="fa-solid fa-eye mr-2"></i>
                View Profile
            </a>
            <a href="{{ route('employees.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg">
        ...
        <div class="form-section">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="emp_no" id="emp_no" value="{{ old('emp_no', $employee->emp_no) }}" readonly
                           class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 text-gray-600 cursor-not-allowed"
                           placeholder="Auto-generated">
                    <p class="text-xs text-gray-500 mt-1">Employee ID is automatically generated and cannot be changed</p>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="dob" id="dob" value="{{ old('dob', $employee->dob ? $employee->dob->format('Y-m-d') : '') }}" required
                ...
                <div>
                    ...
                    <select name="nationality" id="nationality" required
                        ...
                        @foreach($nationalities as $nationality)
                            <option value="{{ $nationality }}" {{ old('nationality', $employee->nationality) == $nationality ? 'selected' : '' }}>
                                {{ $nationality }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    @if($employee->profile_photo)
                        <div class="mb-2">
                            <img src="{{ asset('storage/employees/photos/' . $employee->profile_photo) }}" 
                                 alt="Current photo" class="h-16 w-16 rounded-full object-cover">
        ...
        <div class="form-section">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="contact_number" id="contact_number" value="{{ old('contact_number', $employee->contact_number) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="contact_number_foregn" id="contact_number_foregn" value="{{ old('contact_number_foregn', $employee->contact_number_foregn) }}"
                ...
                <div>
                    ...
                    <input type="email" name="emp_email" id="emp_email" value="{{ old('emp_email', $employee->emp_email) }}"
                ...
                <div>
                    ...
                    <input type="email" name="company_email" id="company_email" value="{{ old('company_email', $employee->company_email) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="persent_address" id="persent_address" rows="3"
                              ...
                              placeholder="Enter present address">{{ old('persent_address', $employee->persent_address) }}</textarea>
        ...
        <div class="form-section">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="designation" id="designation" required
                        ...
                        @foreach($positions as $position)
                            <option value="{{ $position }}" {{ old('designation', $employee->designation) == $position ? 'selected' : '' }}>
                                {{ $position }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="date" name="date_of_join" id="date_of_join" value="{{ old('date_of_join', $employee->date_of_join ? $employee->date_of_join->format('Y-m-d') : '') }}" required
                ...
                <div>
                    ...
                    <input type="number" name="basic_salary" id="basic_salary" value="{{ old('basic_salary', $employee->basic_salary) }}" step="0.01" required
                ...
                <div>
                    ...
                    <select name="salary_currency" id="salary_currency"
                        ...
                        <option value="USD" {{ old('salary_currency', $employee->salary_currency) == 'USD' ? 'selected' : '' }}>USD</option>
                        <option value="EUR" {{ old('salary_currency', $employee->salary_currency) == 'EUR' ? 'selected' : '' }}>EUR</option>
                        <option value="GBP" {{ old('salary_currency', $employee->salary_currency) == 'GBP' ? 'selected' : '' }}>GBP</option>
                        <option value="MVR" {{ old('salary_currency', $employee->salary_currency) == 'MVR' ? 'selected' : '' }}>MVR</option>
                    </select>
        ...
        <div class="form-section">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="passport_nic_no" id="passport_nic_no" value="{{ old('passport_nic_no', $employee->passport_nic_no) }}"
                ...
                <div>
                    ...
                    <input type="date" name="passport_expire_date" id="passport_expire_date" value="{{ old('passport_expire_date', $employee->passport_expire_date ? $employee->passport_expire_date->format('Y-m-d') : '') }}"
                ...
                <div>
                    ...
                    <input type="text" name="wp_no" id="wp_no" value="{{ old('wp_no', $employee->wp_no) }}"
                ...
                <div>
                    ...
                    <input type="text" name="work_site" id="work_site" value="{{ old('work_site', $employee->work_site) }}"
                ...
                <div>
                    ...
                    <input type="text" name="emergency_contact_number" id="emergency_contact_number" value="{{ old('emergency_contact_number', $employee->emergency_contact_number) }}"
