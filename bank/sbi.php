...
$query = "SELECT b.*, e.name AS employee_name, e.xpat_designation, e.xpat_join_date, e.permanent_address, e.basic_salary, e.salary_currency, e.work_site, e.wp_no, e.passport_nic_no 
...
<body>
    ...
    <div class="a4-container">
        <img src="letter_head.png" alt="Logo" class="letterhead">

        <p>The Country Head &amp; Chief Executive Officer<br>State Bank of India<br>Male', Maldives</p>
        <p><?= date('d-M-Y') ?></p>
        
        <h6 class="fw-normal">REQUEST FOR OPENING OF ACCOUNT</h6>
        <p>This is to confirm that the following employee is employed BY Rasheed Carpentry and Construction Pvt Ltd. We hereby confirm his identity details as follows:</p>
        ...
        <div class="signature">
            <p>The above-mentioned employee's monthly salary is currently given cash to the employee. Once Account is opened salary will be credited to SBI From Company Account.</p>
            <p>We request you to kindly assist him in openning an MVR account at State Bank of India, Maldives.</p>
