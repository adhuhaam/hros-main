...
<body class="w3-container">
    ...
    <div class="row">
        ...
        <div class="col-6 columnx header">
            ...
            Loan & Cash Advance Form<br> <p style="text-align: right; color: red; font-size: 8pt;">Confidential</p>
        </div>
    </div>
...
-->
    ...
    <table>
        <tr>
            <th colspan="1" class="section-title">Type</th>
            <th colspan="1" class="section-title"><input type="checkbox" /> Cash / Salary Advance</th>
            <th colspan="1" class="section-title"><input type="checkbox" /> Staff Loan</th>
        </tr>
        <tr>
            <td>Amount:</td>
            <td style="font-size: 12px"><?php echo $loan['currency']; ?> <?php echo $loan['amount']; ?></td> <!----advance----->
            <td style="font-size: 12px"><?php echo $loan['currency']; ?> <?php echo $loan['amount']; ?></td> <!----LOAN----->
        </tr>
        ...
        <tr>
            ...
            <td style="font-size: 12px"><?php echo $loan['purpose']; ?></td> <!----advance----->
            <td style="font-size: 12px"><?php echo $loan['purpose']; ?></td> <!----LOAN----->
        </tr>
        <tr>
            <td style="text-align: right;">Grand Total: <input type="checkbox" /> MVR  <input type="checkbox" /> USD</td>
            <td class="b" style="font-size: 12px"><?php echo $loan['currency']; ?> <?php echo $loan['amount']; ?> </td> <!----advance----->
            <td class="b" style="font-size: 12px"><?php echo $loan['currency']; ?> <?php echo $loan['amount']; ?></td><!----LOAN----->
        </tr>
        </table>
        <table>
        
        <tr>
            <th colspan="3" class="section-title">4.(a) OUTSTANDING DETAILS (To be checked from HR & Finance)</th>
        </tr>
        <tr> 
