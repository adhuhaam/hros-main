...
// Generate profile URL for QR
$profileUrl = "https://verify-mv.vercel.app/?emp_no=" . urlencode($emp_no);
...
$pdf->write2DBarcode($profileUrl, 'QRCODE,H', $qrX, $qrY, $qrSize, $qrSize, $style, 'N');

// === EMP NO (Large, bottom-left) ===
$pdf->SetFont('imagine_font', '', 34);
$pdf->SetXY(2, 29);
$pdf->Cell(25, 8, $emp_no, 0, 1, 'L');

// === DESIGNATION (small, bottom-left below emp_no) ===
$pdf->SetFont('imagine_font', 'L', 8);
$pdf->SetXY(2, 41);
$pdf->Cell(36, 4, $designation, 0, 0, 'L');

// === rcc (small, bottom-left below emp_no) ===
$pdf->SetFont('imagine_font', 'L', 4.5);
$pdf->SetXY(2, 44);
$pdf->Cell(36, 4, 'Rasheed Carpentry & Construction', 0, 0, 'L');

// === NAME (Vertical, rotated  on right) ===
$pdf->StartTransform();
