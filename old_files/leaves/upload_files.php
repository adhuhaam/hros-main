            ...
            <div class="card mt-4">
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="shadow p-4 bg-light rounded">
                        <div class="mb-3">
                            <label for="leave_form" class="form-label">Leave Form:</label>
                            <input type="file" name="leave_form" class="form-control">
                        </div>

                        <div class="mb-3">
                            <label for="departure_sheet" class="form-label">Departure Sheet:</label>
                            <input type="file" name="departure_sheet" class="form-control">
                        </div>
