...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['check_eligibility'])) {
    ...
    if (!$employee) {
        ...
        $success_msg = "Eligible for No Pay Leave.";
        $is_eligible = true;
    }
}
?>
...
<head>
  ...
  <title>No Pay Leave Application</title>
...
<div class="page-wrapper">
    ...
    <div class="body-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mt-4">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">No Pay Leave Application</h5>
                    ...
                    <?php if ($is_eligible) { ?>
                        <form method="POST" action="submit_no_pay_leave.php" class="shadow p-4 bg-light rounded mt-3">
                            ...
                            <button type="submit" class="btn btn-success w-100 mt-3">Submit No Pay Leave</button>
                        </form>
                    <?php } ?>
